    ...
    <div class="content-card">
        ...
        <div class="page-card-header">
            ...
            <div class="lead-detail-actions">
                ...
                @if(
                    ...
                    <form method="POST" action="{{ route('lead.convert', $lead->id) }}"
                ...
                @if(
                            ...
                            <!-- <a href="{{ route('client.show', $lead->client->id) }}" class="primary-btn">
                                                                        Open Client
                                                                    </a> -->
        ...
        <div class="lead-details-grid">
            ...
            <div class="detail-box">
                ...
                <strong>
                    <span class="dynamic-lead-option-badge" style="--lead-option-color:
                                        {{ $lead
        ->statusDefinition
            ?->color
        ?? '#64748B' }}">
