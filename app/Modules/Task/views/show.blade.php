...
@section('content')
    ...
    @php
        ...
        $backRoute = match ($from) {
            'kanban' => route('task.kanban.index'),
            'my' => route('task.my'),
            'index' => route('task.index'),
            default => $canViewAllTasks
            ? route('task.index')
            : route('task.my'),
        };
    ...
    <div class="content-card">
        ...
        $task->project_id
                ...
                @if(
                    ...
                    <a href="{{ route('task.edit', ['task' => $task->id, 'from' => $from]) }}" class="primary-btn"></a></a>
                    Edit Task
                    </a>
                @endif
    ...
    @if(
        ...
        <section class="task-detail-section task-review-panel">
            ...
            <div class="task-review-grid">
                ...
                'task.approve',
                $task->id
            ) }}" class="task-review-form approve"
                    onsubmit="return confirm(
